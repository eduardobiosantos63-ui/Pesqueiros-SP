...
// ATUALIZADO: Adiciona 'Anteninha' a todas as listas de iscas sugeridas.
...
export const MOCK_PESQUEIROS = [
  {
    ...
    // Anteninha adicionada
    iscas_sugeridas: ["Anteninha", "Ração na Pinga", "Goiabada", "Salsicha Flutuante"], 
  ...
  },
  {
    ...
    // Anteninha adicionada
    iscas_sugeridas: ["Anteninha", "Ração na Pinga", "Salsicha", "Massa de Banana"], 
  ...
  { 
    ...
    // Anteninha adicionada
    iscas_sugeridas: ["Anteninha", "Milho", "Pão de Queijo", "Massa de Queijo"], 
